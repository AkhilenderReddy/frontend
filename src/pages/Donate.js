...
function Donate() {
  ...
  return (
    <div className="flex  h-full md:gap-1 ">
      <Sidebar />
      <div className="scroll  relative h-full flex-1 p-4 bg-purple-50  dark:bg-gray-800 overflow-scroll">
        <header className="border-b-4 border-purple-300  dark:border-gray-500 ">
          <h1 className="md:text-2xl mb-3 font-semibold  text-purple-500   dark:text-white">
            Donate
          </h1>
        </header>

        {
          loading ? (
            ...
            >
              {/* food Items */}
              <div className="mb-8">
                <h1 className=" text-xl mb-6 font-semibold  text-purple-500   dark:text-white">
                  Food Items
                </h1>
                <div>
                  <ul>
                    {foodItems.map((item, i) => (
                      ...
                      >
                        <input
                          type="text"
                          id="Food Item"
                          className="  max-w-lg bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                        ...
                        <div className="flex gap-3 ">
                          <input
                            type="Number"
                            id="Quantity"
                            className="bg-gray-50 border w-28 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                          ...
                          {i !== 0 && (
                            <button
                              className="py-2  px-3 text-xs font-semibold text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                              onClick={() =>
                                setFoodItems(
                ...
                <button
                  ...
                  className="py-2 mt-4 px-3 text-xs font-semibold text-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800"
                >
                  Add more
                </button>
              ...
              <div className="mb-8">
                <label
                  id="address"
                  className=" text-xl mb-6 font-semibold  text-purple-500   dark:text-white"
                >
                  PickUp Address
                </label>
                <div className="flex md:flex-row  flex-col  gap-3 items-end">
                  <textarea
                    ...
                    className="  md:max-w-lg  mt-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                    required
              ...
              <div className="mb-8">
                <label
                  htmlFor="message"
                  className=" text-xl  font-semibold  text-purple-500   dark:text-white"
                >
                  Message
                </label>
                <textarea
                  id="message"
                  rows="3"
                  className="block p-2.5 md:max-w-lg   w-full mt-6 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
