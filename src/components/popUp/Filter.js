...
function Filter() {
  ...
  const ExampleCustomInput = React.forwardRef(({ value, onClick }, ref) => (
    <input
      className="w-[17rem] h-10  text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800"
      onClick={onClick}
      ref={ref}
      defaultValue={value}
      readOnly
  ...
  return (
    <>
      ...
      <button
        ...
        type="button"
        className="text-purple-700  md:mr-8 mb-2 border border-purple-700 hover:bg-purple-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-xl text-sm p-2.5 text-center inline-flex items-center dark:border-purple-500 dark:text-purple-500 dark:hover:text-white dark:focus:ring-purple-800"
      >
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 text-center ">
                ...
                <div className="flex  gap-5   mt-16  flex-wrap  justify-center items-center">
                  <button
                    type="button"
                    className="text-white    bg-purple-600 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:purple-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center "
