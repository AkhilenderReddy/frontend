...
function DonationInfo({ currentPage, path }) {
  ...
  return (
    <>
      <header className="  px-4 pt-4    border-b-4    border-purple-300  dark:border-gray-500 ">
        <h1 className="    text-lg md:text-2xl mb-3 font-semibold  text-purple-500   dark:text-white">
          <Link
              ...
              <div className=" mt-4   flex flex-col gap-3">
                ...
                <p
                  className={`${
                    ...
                    (donation.status === "COLLECTED" && "text-purple-500")
                  }
                   font-bold
                  `}
                >
