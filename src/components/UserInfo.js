...
function UserInfo({ currentUser, setCurrentUser, role }) {
  ...
  return (
    <div>
      {/* header */}
      <header
        className={` bg-purple-50  dark:bg-gray-800  z-10 border-b-4   ${
          showShadow ? "" : "sticky top-0 left-0"
        }   border-purple-300  dark:border-gray-500 px-4 pt-4 shadow-xl `}
      >
        <div className="   text-xl md:text-2xl mb-3 font-semibold  text-purple-500   dark:text-white   flex  md:gap-0 gap-2 md:flex-row flex-col  md:items-center md:justify-between   ">
      ...
      {loading ? (
        ...
        <>
          <div
            className={
              showShadow
                ? " sticky  md:px-4 py-2   shadow-2xl md:top-0 border-purple-300  dark:border-gray-500 px-4 pt-4 border-b-4  left-0  z-10 text-xl md:text-2xl mb-3 font-semibold  flex   justify-between  text-purple-500   dark:text-white  bg-purple-50  dark:bg-gray-800"
                : "sticky  md:px-4 py-2 md:top-[4rem]  left-0  z-10 text-xl md:text-2xl mb-3 font-semibold  flex   justify-between  text-purple-500   dark:text-white  bg-purple-50  dark:bg-gray-800"
            }
          >
            <p>
