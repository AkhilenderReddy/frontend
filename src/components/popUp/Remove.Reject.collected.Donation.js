  ...
  return (
    <>
      <button
        className={
          type === "COLLECTED"
            ? " mx-2   py-2 px-3 text-xs font-medium text-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800"
              ...
              <div className="p-6 text-center ">
                ...
                <div className="flex  gap-5    flex-wrap  justify-center items-center">
                  <button
                    ...
                    className={
                      type === "COLLECTED"
                        ? "text-white bg-purple-600 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
