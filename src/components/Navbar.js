                ...
                <Link
                  ...
                  className={
                    location.pathname === "/sign_in"
                      ? " py-2 px-3 text-sm font-medium text-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800"
                      : "py-2 px-3 text-sm text-purple-700 hover:text-white border border-purple-700 hover:bg-purple-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg  text-center  dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800"
                  }
                >
                  SignIn
                </Link>{" "}
              ...
              <div className="flex items-center  space-x-3   cursor-pointer ">
                ...
                {/* {Object.keys(userData).length > 0 ? (
                  <div
                    ...
                    className="notificationButton md:mr-8  mr-4 h-8 relative  p-1 w-8   dark:text-purple-500  dark:hover:bg-gray-800  hover:bg-gray-100  rounded-full flex items-center justify-center"
                  > */}
                {/* {showNotificationComponent ? (
                      <svg
                        aria-hidden="true"
