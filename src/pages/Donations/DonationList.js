...
function DonationList({ setCurrentPage }) {
  ...
  return (
    <>
      {/* header */}
      <header className="  top-0  left-0 pt-4  px-4 shadow-xl   border-b-4  flex justify-between items-center bg-purple-50  dark:bg-gray-800   border-purple-300  dark:border-gray-500 ">
