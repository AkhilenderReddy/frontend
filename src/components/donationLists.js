...
function DonationList({ setCurrentPage, donationsUrl, PageType, baseUrl }) {
  ...
  return (
    <>
      <header className=" sticky top-0  left-0 pt-4  px-4 shadow-xl   border-b-4  flex justify-between items-center  bg-purple-50  dark:bg-gray-800  border-purple-300    dark:border-gray-500 ">
        ...
        <div className="hidden md:block mt-4">
          ...
          Object.keys(donationData.donations).length < 1 ? (
            <div className=" w-full text-center mt-6">
              <p className="   text-purple-500  opacity-50   font-bold text-4xl">
                Donate Food
              </p>
            </div>
          ) : null}
