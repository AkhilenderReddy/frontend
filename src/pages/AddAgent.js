...
function AddAgent() {
  ...
  return (
    <div className="flex  h-full md:gap-1 ">
      <Sidebar />
      <div className="scroll  relative h-full flex-1  bg-purple-50  dark:bg-gray-800 overflow-scroll">
        <header className="   sticky top-0 left-0 pt-4  px-4 border-b-4 bg-purple-50 z-10  dark:bg-gray-800 border-purple-300  dark:border-gray-500 ">
        ...
        <div className="flex  w-full  justify-center items-center">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full  flex   justify-center text-white bg-purple-700  hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center"
            >
              Add Agent
              {addAgentLoading ? (
                <svg
