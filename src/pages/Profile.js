...
function Profile() {
  ...
  return (
    <div className="flex  h-full md:gap-1">
      <Sidebar />
      <div className="scroll h-full relative flex-1  bg-purple-50  dark:bg-gray-800 overflow-scroll">
        <header className="md:block   sticky top-0 left-0  hidden  pt-4  px-4 border-b-4    border-purple-300  dark:border-gray-500  bg-purple-50  dark:bg-gray-800 z-10">
          <h1 className="   text-xl md:text-2xl mb-3 font-semibold  text-purple-500   dark:text-white">
            Profile
          </h1>
        </header>
        {/* profile body */}
                ...
                <div>
                  <div className="flex  pt-4   md:gap-10         flex-col items-center ">
                    ...
                    <div className="relative">
                      ...
                      <div
                        ...
                        className="absolute text-sm bottom-5 left-[8rem]  h-9 w-9 rounded-full cursor-pointer  hover:shadow-2xl    bg-purple-200  hover:bg-purple-100 dark:bg-[#9885855d] dark:hover:bg-[#98858526] flex items-center  justify-center"
                      >
                        <svg
                  ...
                  <div className="mb-3    ">
                    ...
                    <input
                      ...
                      id="phoneNo"
                      className="md:w-fit  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                      required
                      maxLength="10"
                      minLength="10"
                  ...
                  <div className="mb-3  ">
                    ...
                    <textarea
                      ...
                      setEditedData
                      className="  md:max-w-lg  bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-purple-500 dark:focus:border-purple-500"
                      required
          ...
          <div className="p-4">
            <div className="relative flex justify-center items-center flex-col md:mt-4 ">
              ...
              <div className="relative">
                ...
                <p className="absolute text-sm bottom-5 left-24 h-6 w-[4rem] flex items-center justify-center bg-purple-500  text-white font-semibold rounded-3xl">
                  {userData.role}
                </p>
              </div>
              {/* profile image  end*/}
              ...
              <div className="text-center  ">
                <p className="text-xl text-purple-500    font-semibold  dark:text-gray-100">
                  {" "}
                  {userData.firstName + " " + userData.lastName}
                </p>
                <p className="text-purple-500   dark:text-gray-300">
                  {userData.email}
                </p>
              </div>
              {/* name email end */}
            ...
            <div className="mt-12  max-w-3xl">
              <h1 className="text-xl md:text-xl mb-3 font-semibold  text-purple-500   dark:text-white flex gap-2">
                PhoneNo :{" "}
                <span className="text-lg  font-semibold text-gray-500">
                  {userData.phoneNo}
                </span>
              </h1>
              <div className="text-xl md:text-xl mb-3 font-semibold  text-purple-500   dark:text-white flex item gap-2 ">
                Address:{" "}
                <span className="text-lg  font-semibold text-gray-500">
                  {userData.address}
                </span>
              </div>
              <h1 className="text-xl md:text-xl mb-3 font-semibold  text-purple-500   dark:text-white gap-2 flex">
                Password :
                <span className="text-lg  font-semibold text-gray-500">
                  {" "}
                  xxxxxxxx
              ...
              {/* <h1 className=" md:hidden text-xl md:text-xl mb-3 font-semibold  text-purple-500   dark:text-white">
                Theme :
